...
function createChartAnalysis(scores) {
  ...
  text += max - min > 3 ? `<br>영역별 점수 차이가 큰 편입니다. 균형 있는 발전을 위해 <span class="highlight-strength">'${weakest.join("', '")}'</span> 영역에 더 관심을 기울여보세요.` : '<br>영역별 점수가 비슷한 편입니다. 모든 영역이 고르게 발전하고 있습니다.';
